...
[ -n "$${IPKG_INSTROOT}" ] && {
	...
	$${HOST_SED} 's/"192.168.1.1"/"192.168.1.1"/' \
	...
	$${HOST_SED} "s/'192\\.168\\.1\\.1'/'192.168.1.1'/; s/'openwrt\\.lan'/window.location.host/" "$${IPKG_INSTROOT}/www/luci-static/resources/view/system/flash.js"
